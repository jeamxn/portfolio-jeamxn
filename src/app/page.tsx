                ...
                isFetching ? Array(6).fill(0).map((_, i) => (
                  ...
                  <div key={i} className="w-[calc(33.33%-2rem)] group max-2xl:w-[calc(50%-1rem)] max-lg:w-[calc(33.33%-2rem)] max-md:w-[calc(50%-1rem)] max-sm:w-full rounded-xl overflow-hidden shadow dark:shadow-white/35 flex flex-col">
                    <a href={project.url} target="_blank" rel="noreferrer">
                      <img src={project.cover} alt={project.data.title} className="object-cover aspect-video loader bg-gradient-to-br from-black/10 via-white to-black/10 dark:from-white/30 dark:via-black dark:to-white/30" width={160 * 5} height={90 * 5} />
                      <div className="flex flex-row items-center justify-start p-4 gap-3">
                        <img src={project.icon} alt={project.data.title} className="object-cover w-12 h-12 rounded-xl loader bg-gradient-to-br from-black/10 via-white to-black/10 dark:from-white/30 dark:via-black dark:to-white/30 shadow dark:shadow-white/35" width={200} height={200} />
                ...
                isFetching ? Array(4).fill(0).map((_, i) => (
                  ...
                  <div key={i} className="flex flex-row gap-8 max-md:flex-col max-md:gap-4">
                    ...
                    <div className="flex flex-row gap-4">
                      <img src={award.icon} alt={award.name} className="object-cover w-12 h-12 rounded-xl loader bg-gradient-to-br from-black/10 via-white to-black/10 dark:from-white/30 dark:via-black dark:to-white/30 shadow dark:shadow-white/35" width={200} height={200} />
              ...
              <div className="flex flex-col gap-4 flex-warp">
                {
                  isFetching ? Array(3).fill(0).map((_, i) => (
                    ...
                    <div className="flex flex-row gap-4 items-center" key={i}>
                      <div className="shadow dark:shadow-white/35 bg-white w-10 h-10 rounded-xl overflow-hidden">
                        <img src={team.icon} alt={team.name} className="object-cover w-10 h-10 loader bg-gradient-to-br from-black/10 via-white to-black/10 dark:from-white/30 dark:via-black dark:to-white/30" width={200} height={200} />
                      </div>
